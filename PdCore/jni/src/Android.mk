...
LOCAL_SRC_FILES := \
	...
	d_resample.c d_soundfile.c d_ugen.c g_all_guis.c g_array.c \
	g_bang.c g_canvas.c g_editor.c g_graph.c g_guiconnect.c g_hdial.c \
	...
	m_memory.c m_obj.c m_pd.c m_sched.c s_audio.c s_audio_dummy.c s_entry.c \
